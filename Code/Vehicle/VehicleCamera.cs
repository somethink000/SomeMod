...
public sealed class VehicleCamera : Component
{
	...
	[Property] public Vehicle Car { get; set; }
	...
	protected override void OnFixedUpdate()
	{
		...
		//
		{
			...
			Car.Driver.Camera.Transform.Position = Vector3.Lerp( Transform.Position, targetPosition, PositionSensitivity * Time.Delta );
			Car.Driver.Camera.Transform.Rotation = Rotation.Lerp( Transform.Rotation, targetRotation, RotationSensitivity * Time.Delta );
		}
	}
}
